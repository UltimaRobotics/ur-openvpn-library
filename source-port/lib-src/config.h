...
#define CONFIGURE_DEFINES "enable_async_push=no enable_comp_stub=no enable_crypto=yes enable_crypto_ofb_cfb=yes enable_dco=auto enable_dco_arg=auto enable_debug=yes enable_dlopen=unknown enable_dlopen_self=unknown enable_dlopen_self_static=unknown enable_dns_updown_by_default=yes enable_fast_install=needless enable_fragment=yes enable_iproute2=no enable_libtool_lock=yes enable_lz4=yes enable_lzo=yes enable_management=yes enable_ntlm=yes enable_pam_dlopen=no enable_pedantic=no enable_pkcs11=no enable_plugin_auth_pam=yes enable_plugin_down_root=yes enable_plugins=yes enable_port_share=yes enable_selinux=no enable_server=yes enable_shared=yes enable_shared_with_static_runtimes=no enable_small=no enable_static=yes enable_strict=no enable_strict_options=no enable_systemd=no enable_werror=no enable_win32_dll=yes enable_wolfssl_options_h=yes enable_x509_alt_username=no with_aix_soname=aix with_crypto_library=openssl with_gnu_ld=yes with_mem_check=no with_openssl_engine=auto with_sysroot=no"
...
/* Define to 1 if you have the `mbedtls_ssl_conf_export_keys_ext_cb' function.
   */
/* #undef HAVE_MBEDTLS_SSL_CONF_EXPORT_KEYS_EXT_CB */

/* Define to 1 if you have the `mbedtls_ssl_set_export_keys_cb' function. */
/* #undef HAVE_MBEDTLS_SSL_SET_EXPORT_KEYS_CB */

/* Define to 1 if you have the `mbedtls_ssl_tls_prf' function. */
...
#define OPENVPN_VERSION_PATCH "_alpha3"
...
#define PACKAGE_STRING "OpenVPN 2.7_alpha3"
...
#define PACKAGE_VERSION "2.7_alpha3"
